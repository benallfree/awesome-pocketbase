...
- [PocketBase admin CLI tool](https://github.com/ssakone/pb_cli) - A command-line interface tool for managing PocketBase collections and profiles. ![GitHub Repo stars](https://img.shields.io/github/stars/ssakone/pb_cli)
