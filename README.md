...
- [JustJot](https://justjot.app) - ([frontend repo](https://github.com/JunoNgx/justjot-frontend) / [backend repo](https://github.com/JunoNgx/justjot-backend)) A keyboard-first note-taking full-featured Progressive Web App.