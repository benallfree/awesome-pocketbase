...
* (WIP)[PocketBase Vue/Vuetify 3 Starter](https://github.com/MRSessions/pocketbase-vue-starter) A starter template for using Vue/Vuetify served from PocketBase (used as a Go framework/toolkit) as a backend.
